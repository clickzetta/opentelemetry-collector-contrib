module github.com/open-telemetry/opentelemetry-collector-contrib/exporter/clickzettaexporter

go 1.25.0

require (
	github.com/clickzetta/goclickzetta v0.0.16
...
require google.golang.org/genproto/googleapis/rpc v0.0.0-20251222181119-0a764e51fe1b // indirect

require go.opentelemetry.io/collector/config/configoptional v1.55.0
